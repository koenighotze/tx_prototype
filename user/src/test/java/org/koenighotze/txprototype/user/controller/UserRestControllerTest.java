...
@DirtiesContext
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, classes = {UserAdministrationApplication.class, EmbeddedMongoAutoConfiguration.class})
